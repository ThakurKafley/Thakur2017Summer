...
import edu.gsu.httpcs.thakur2017summer.adapter.ScalePagerAdapter;
...
public class ScaleTypeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewaPager =(ViewPager)findViewById(R.id.activity_scale_view_page);
